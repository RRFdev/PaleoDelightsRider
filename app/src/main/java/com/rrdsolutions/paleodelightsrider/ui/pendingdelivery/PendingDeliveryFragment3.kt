...
class PendingDeliveryFragment3 : Fragment() {
    private lateinit var vm: PendingDeliveryViewModel3
    lateinit var root: View
    override fun onCreateView(
        inflater: LayoutInflater, container: ViewGroup?,
        savedInstanceState: Bundle?
    ): View? {
        vm = ViewModelProvider(this).get(PendingDeliveryViewModel3::class.java)
